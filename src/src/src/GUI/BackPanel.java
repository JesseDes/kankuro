...
public class BackPanel extends JPanel {
	 ...
	 * dynamic constructor
	 * @param int[][] arr
	 * @author modified by ZHOU
	 */
	public BackPanel(int[][] arr) {
		//Instantiating and setting GridBagLayout and GridBagConstraints
		this.gbl = new GridBagLayout();
		this.gbc = new GridBagConstraints();
		this.setLayout(this.gbl);
	...
	/**
	 * Dynamic accessor method so that AppModel and AppController can access the BackPanel
	 * @return BackPanel object
	 */
public static BackPanel getBackPanel(int[][] arr) {
    		backPanelInstance = new BackPanel(arr);
    	return backPanelInstance;
	}
